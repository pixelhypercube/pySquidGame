...
class Home(GameHandler):
    ...
    def render(self, frame, mouse_x, mouse_y):
        ...
        helper.render_text(frame,"(beta)",WIDTH/3.5,HEIGHT/2.5,font_size=32)
        ...
        if mouse_x>=WIDTH/2-90 and mouse_x<=WIDTH/2+90 and mouse_y>=HEIGHT/1.35-50 and mouse_y<=HEIGHT/1.35+50:
            helper.render_image(frame,"./assets/img/invitationBack1.png",WIDTH/2,HEIGHT/1.35)
        else:
            helper.render_image(frame,"./assets/img/invitationFront.png",WIDTH/2,HEIGHT/1.35)